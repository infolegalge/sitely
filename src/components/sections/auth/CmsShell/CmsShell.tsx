...
const NAV_ITEMS = [
  ...
  { href: "/secure-access/clients", label: "კლიენტები 1", icon: Users },
  { href: "/secure-access/offers", label: "შეთავაზება 2", icon: FileBadge },
  { href: "/secure-access/marketing", label: "მარკეტინგი 3", icon: Megaphone },
