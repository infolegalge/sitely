...
const css = `/* ═══════════════════════════════════════════
   ...
   "Cosmic Orbit" v4 — 3D Box Carousel

   Cards orbit in 3D space with physical depth.
   3 cards visible: center (frontmost) + sides.
   Cards have box-model thickness via edge divs.
   GSAP continuous rotation, drag, dot nav.
...
.card.active .cardFront {
  ...
  box-shadow:
    0 16px 48px rgba(79, 110, 247, 0.12),
...
console.log("\nDone! Cosmic Orbit v4 — 3D box cards, 3 visible, smaller.");
